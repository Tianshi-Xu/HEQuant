...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --standalone --nproc_per_node=4 train_quant.py -c configs/quantized/resnet18/imagenet.yml --model ResNet18 /data1/share/imagenet
